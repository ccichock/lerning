...
class Test_form(unittest.TestCase):
    ...
    def test_textarea(self):
        ...
        self.assertEqual(textarea_html.html(), f'<textarea>\n\n</textarea>')


    def test_textarea_class(self):
        textarea_html = textarea()
        textarea_html.add_class("from-control")
        self.assertEqual(textarea_html.html(), f'<textarea class="from-control">\n\n</textarea>')
    ...
    def test_textarea_class_placeholder(self):
        ...
        self.assertEqual(textarea_html.html(), f'<textarea class="from-control" placeholder="Type your message">\n\n</textarea>')
    ...
    def test_Form_textarea_class_placeholder(self):
        ...
        expect_textarea = f'<textarea class="from-control" placeholder="Type your message">\n\n</textarea>'
